...
if( class_exists( 'Yoast_License_Manager' ) &&  ! class_exists( "Yoast_Theme_License_Manager", false ) ) {
	...
	class Yoast_Theme_License_Manager extends Yoast_License_Manager {
		...
		public function add_license_menu() {
			$theme_page = add_theme_page( sprintf( esc_html__( '%s License', $this->product->get_text_domain() ), $this->product->get_item_name() ), esc_html__( 'Theme License', $this->product->get_text_domain() ), 'manage_options', 'theme-license', array( $this, 'show_license_page' ) );
		}
