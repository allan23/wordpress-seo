...
class Sample_Plugin {
	...
	public function add_license_menu() {
		$theme_page = add_options_page( sprintf( esc_html__( '%s License', $this->text_domain ), $this->item_name ), sprintf( esc_html__( '%s License', $this->text_domain ), $this->item_name ), 'manage_options', $this->text_domain . '-license', array( $this, 'show_license_page' ) );
	}
