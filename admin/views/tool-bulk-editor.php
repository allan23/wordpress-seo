...
$_GET['type'] = ( ! empty( $_GET['type'] ) ) ? sanitize_text_field(wp_unslash($_GET['type'])) : 'title';
...
?>
<script>
	var wpseo_bulk_editor_nonce = '<?php echo wp_create_nonce( 'wpseo-bulk-editor' ); /* xss okay */  ?>';
</script>
