...
<table class="wpseo">
	<tr>
		...
		<td><?php esc_html_e( 'A link to the archive for the post author, with the authors name as anchor text.', 'wordpress-seo' ); ?></td>
	</tr>
	<tr>
		<th><strong><code>%%POSTLINK%%</code></strong></th>
		<td><?php esc_html_e( 'A link to the post, with the title as anchor text.', 'wordpress-seo' ); ?></td>
	</tr>
	<tr>
		<th><strong><code>%%BLOGLINK%%</code></strong></th>
		<td><?php esc_html_e( "A link to your site, with your site's name as anchor text.", 'wordpress-seo' ); ?></td>
	</tr>
	<tr>
		<th><strong><code>%%BLOGDESCLINK%%</code></strong></th>
		<td><?php esc_html_e( "A link to your site, with your site's name and description as anchor text.", 'wordpress-seo' ); ?></td>
	</tr>
</table>
