...
if ( '' === $tool_page ) {
	...
	$tools = array(
		'bulk-editor' => array(
			'title' => esc_html__( 'Bulk editor', 'wordpress-seo' ),
			'desc' => esc_html__( 'This tool allows you to quickly change titles and descriptions of your posts and pages without having to go into the editor for each page.', 'wordpress-seo' ),
		),
		'import-export' => array(
			'title' => esc_html__( 'Import and Export', 'wordpress-seo' ),
			'desc' => esc_html__( 'Import settings from other SEO plugins and export your settings for re-use on (another) blog.', 'wordpress-seo' ),
		),
	);
	if ( WPSEO_Utils::allow_system_file_edit() === true && ! is_multisite() ) {
		$tools['file-editor'] = array(
			'title' => esc_html__( 'File editor', 'wordpress-seo' ),
			'desc' => esc_html__( 'This tool allows you to quickly change important files for your SEO, like your robots.txt and, if you have one, your .htaccess file.', 'wordpress-seo' ),
		);
	}
	...
	$tools['recalculate'] = array(
		...
		'title'   => esc_html__( 'Recalculate SEO scores', 'wordpress-seo' ),
		'desc'    => esc_html__( 'Recalculate SEO scores for all pieces of content with a focus keyword.', 'wordpress-seo' ),
	);
